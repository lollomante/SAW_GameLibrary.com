...
<body>
    ...
    <form action = "userprofile.php" method="post"  enctype="multipart/form-data">
        <div>    
            <img class="rounded-circle mt-5" width="150" src=<?php echo $profilepic;?> alt="your profile picture">
            <p><label>Change pic</label></p>
            <input type="file" id = "ProfilePic" name="ProfilePic"/>
        </div>
        <div>
            <label for="firstname">First name:</label>
            <input type="text" placeholder="<?php echo htmlspecialchars($firstname);?>" id="firstname" name="firstname"><br><br>

            <label for="lastname">Last name:</label>
            <input type="text" placeholder="<?php echo htmlspecialchars($lastname);?>" id="lastname" name="lastname"><br><br>
